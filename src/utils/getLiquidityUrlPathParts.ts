...
const getLiquidityUrlPathParts = ({ quoteTokenAddresses, quoteTokenSymbol, tokenAddresses, pid }) => {
  const chainId = process.env.REACT_APP_CHAIN_ID
  const firstPart = quoteTokenSymbol === 'MATIC' ? 'ETH' : quoteTokenAddresses[chainId]
